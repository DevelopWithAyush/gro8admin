...
import UserProfile, { MentorProfileData } from "./UserProfile";

interface UserProfileSectionProps {
  data: MentorProfileData;
}

const UserMentorProfileSection = ({ data }: UserProfileSectionProps) => {
  return (
      ...
      <div className="p-5 flex flex-row items-start justify-normal border-[1px] border-solid border-[#E8E8F1] w-full bg-[#FFF] rounded-[12px] gap-[15px] ">
        ...
        <div className="flex flex-col items-start justify-start gap-2">
          ...
          <p className="text-[12px] leading-normal text-[#383838] font-rubik-regular_400">
            {data.profile.mentorProfile.expertise.startups[0]?.details || "No details available"}
          </p>
        </div>
      </div>
...
export default UserMentorProfileSection;
