    ...
    <div className="p-5 bg-[#FFF] flex flex-col items-start justify-start gap-3 border border-solid border-[#E8E8F1] rounded-[12px] w-full">
      <div className="flex flex-row items-center justify-between w-full">
        ...
        {pathname === "/dashboard/startup/startup-list" ? (<></>):(
          <Link
            href="/dashboard/startup/startup-list"
      ...
      <StartupTable />
      {pathname === "/dashboard/startup/startup-list" ? (<div className="flex flex-row items-end justify-end w-full font-rubik-semibold_600 ">pagination</div>) : (<></>)}
