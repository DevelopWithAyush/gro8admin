...
import { useGetStartupManagementQuery } from "@/store/features/managementApi";
import CustomPagination from "../CustomPagination";
import { useEffect, useState } from "react";
import { FetchBaseQueryError } from "@reduxjs/toolkit/query";
import { SerializedError } from "@reduxjs/toolkit";
import StartupActiveTable from "./StrartupActiveTable";
...
const StartupActiveDeals = () => {
    const { pathname } = usePaths();
    const isStartupList = pathname === "/dashboard/startup/active-deals";
    ...
    return (
        <div className="p-5 bg-[#FFF] flex flex-col items-start justify-start gap-3 border border-solid border-[#E8E8F1] rounded-[12px] w-full">
            ...
            {isLoading ? (
                ...
                <StartupActiveTable data={startupResponse?.data || []} />
            )}
...
export default StartupActiveDeals;
