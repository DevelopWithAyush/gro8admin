...
import Activity from "./UserActivity/Activity";
  ...
  return (
    <div className="w-full flex flex-col items-start justify-start gap-[13px]">
      ...
      >
        ...
        {active.id === "activity" && <Activity />}
      </motion.div>
    </div>
  );
};

export default ActiveSyndicateTabs;
