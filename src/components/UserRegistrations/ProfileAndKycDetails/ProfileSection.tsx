    ...
    <div className="w-full grid grid-cols-2 gap-x-4 gap-y-7">
      ...
      <div className="col-span-2 flex flex-col gap-1">
        ...
        <div className="flex flex-row gap-x-2">
          ...
          <div className="col-span-2 flex flex-col gap-1">
              <p className=" text-[#7D7D88] text-[12px] font-rubik-light_300 leading-[110%] ">What Countries is the user filing tax returns in</p>
              <p className=" text-[#151517] text-[16px] font-rubik-regular_400 leading-[110%] ">India, United Kingdom</p>
          </div>
    </div>
  );
};
